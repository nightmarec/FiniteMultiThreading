...
#define MyMap_CLock_Mutex_t                 omp_lock_t
#define MyMap_CLock_Mutex_Init(_mutex)      (omp_init_lock(&_mutex))
#define MyMap_CLock_Mutex_Lock(_mutex)      (omp_set_lock(&_mutex))
#define MyMap_CLock_Mutex_UnLock(_mutex)    (omp_unset_lock(&_mutex))
#define MyMap_CLock_Mutex_Destroy(_mutex)   (omp_unset_lock(&_mutex))
